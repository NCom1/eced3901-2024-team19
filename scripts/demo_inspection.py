...
def main():
    ...
    inspection_route = [
        ...
        [3.454, 0.508, 1.571],
        [1.442, 0.508, 0.000],
        [1.442, , 1.571], %Following waypoints are 2-5 for spice on our side need updated y values
        [1.118, , 3.1415],
        [1.118, , 1.571],
        [0.813, , 0.000],
        [0.813, 3.175, 1.571],
    ...
    inspection_route = [
        ...
        [2.337, 1.346, ],
        [2.375, 2.032, ],
        [, 1.841, -1.571],    #Waypoint that makes contact with the thumper (Need x point in a way that only a small part touches (depends on extended attachment)
